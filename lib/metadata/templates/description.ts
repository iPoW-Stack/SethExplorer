...
const DEFAULT_TEMPLATE = 'Seth Explorer is an open blockchain explorer for the %network_title% network. Search transactions, verify smart contracts, analyze addresses, and monitor on-chain activity in real time.';
...
const TEMPLATE_MAP: Record<Route['pathname'], string> = {
  ...
  '/gas-tracker': 'Explore real-time %network_title% gas fees with Seth Explorer\'s gas tracker. Get accurate %network_gwei% estimates and monitor transaction costs live.',
