...
const semanticTokens: ThemingConfig['semanticTokens'] = {
  colors: {
    ...
    border: {
      divider: { value: { _light: '{colors.blackAlpha.100}', _dark: '{colors.seth.border}' } },
      error: { value: '{colors.red.500}' },
    },
    icon: {
    ...
    button: {
      ...
      subtle: {
        ...
        bg: {
          DEFAULT: { value: { _light: '{colors.blackAlpha.200}', _dark: 'rgba(10, 16, 20, 0.8)' } },
        },
      },
      dropdown: {
        fg: {
        ...
        border: {
          DEFAULT: { value: { _light: '{colors.gray.100}', _dark: '{colors.seth.border}' } },
        },
      },
      header: {
        fg: {
          DEFAULT: { value: { _light: '{colors.blackAlpha.800}', _dark: '{colors.gray.300}' } },
        ...
        bg: {
          selected: { value: { _light: '{colors.blackAlpha.50}', _dark: 'rgba(0, 255, 163, 0.12)' } },
      ...
      icon_background: {
        bg: {
          DEFAULT: { value: { _light: '{colors.gray.50}', _dark: 'rgba(10, 16, 20, 0.72)' } },
        },
      },
      pagination: {
        fg: {
          DEFAULT: { value: { _light: '{colors.blackAlpha.800}', _dark: '{colors.whiteAlpha.900}' } },
        },
        border: {
          DEFAULT: { value: { _light: '{colors.gray.100}', _dark: '{colors.seth.border}' } },
        },
    ...
    link: {
      ...
      navigation: {
        ...
        bg: {
          ...
          group: { value: { _light: '{colors.white}', _dark: '{colors.seth.card}' } },
        },
      },
      menu: {
        DEFAULT: { value: { _light: '{colors.blackAlpha.800}', _dark: '{colors.whiteAlpha.800}' } },
    ...
    popover: {
      DEFAULT: {
        bg: { value: { _light: '{colors.white}', _dark: '{colors.seth.card}' } },
    ...
    tabs: {
      ...
      secondary: {
        ...
        border: {
          DEFAULT: { value: { _light: '{colors.gray.300}', _dark: '{colors.seth.border}' } },
        },
      },
      segmented: {
        fg: {
    ...
    input: {
      ...
      bg: {
        DEFAULT: { value: { _light: '{colors.white}', _dark: '{colors.seth.card}' } },
        readOnly: { value: { _light: '{colors.gray.200}', _dark: 'rgba(10, 16, 20, 0.58)' } },
      },
      border: {
        DEFAULT: { value: { _light: '{colors.gray.100}', _dark: '{colors.seth.border}' } },
        hover: { value: { _light: '{colors.gray.200}', _dark: 'rgba(0, 255, 163, 0.32)' } },
        focus: { value: '{colors.hover}' },
        filled: { value: { _light: '{colors.gray.100}', _dark: '{colors.seth.border}' } },
        readOnly: { value: { _light: '{colors.gray.200}', _dark: '{colors.seth.border}' } },
        error: { value: '{colors.red.500}' },
      },
      placeholder: {
    ...
    badge: {
      gray: {
        bg: { value: { _light: '{colors.blackAlpha.50}', _dark: 'rgba(255, 255, 255, 0.08)' } },
        fg: { value: { _light: '{colors.blackAlpha.800}', _dark: '{colors.whiteAlpha.800}' } },
      },
      green: {
        bg: { value: { _light: '{colors.green.50}', _dark: 'rgba(0, 255, 163, 0.18)' } },
        fg: { value: { _light: '{colors.green.500}', _dark: '{colors.seth.primary}' } },
      },
      red: {
    ...
    table: {
      header: {
        bg: { value: { _light: '{colors.blackAlpha.100}', _dark: 'rgba(10, 16, 20, 0.96)' } },
        fg: { value: { _light: '{colors.blackAlpha.700}', _dark: '{colors.gray.400}' } },
      },
    },
    checkbox: {
      control: {
  ...
  shadows: {
    popover: {
      DEFAULT: { value: { _light: '{shadows.size.2xl}', _dark: '0px 18px 40px rgba(0, 0, 0, 0.48), 0px 0px 0px 1px rgba(0, 255, 163, 0.08)' } },
    },
    drawer: {
      DEFAULT: { value: { _light: '{shadows.size.lg}', _dark: '0px 18px 40px rgba(0, 0, 0, 0.48), 0px 0px 0px 1px rgba(0, 255, 163, 0.08)' } },
    },
  },
  opacity: {
    control: {
