  ...
  variants: {
    variant: {
      solid: {
        ...
        boxShadow: { _light: 'none', _dark: '0 0 18px rgba(0, 255, 163, 0.26)' },
        _hover: {
          bg: 'hover',
          color: { _light: 'white', _dark: 'black' },
        },
      ...
      header: {
        bg: { _light: 'transparent', _dark: 'rgba(10, 16, 20, 0.65)' },
      ...
      pagination: {
        borderWidth: '2px',
        borderStyle: 'solid',
        bg: { _light: 'transparent', _dark: 'rgba(10, 16, 20, 0.72)' },
