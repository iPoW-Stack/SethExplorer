...
import type { FontFamily, UIStrictConfig, SethStrictDataSource } from 'types/ui';
...
const defaultColorTheme = (() => {
  ...
  return COLOR_THEMES.find((theme) => theme.id === (envValue ?? 'seth')) as ColorTheme | undefined;
})();
...
const UI = Object.freeze({
  navigation: {
    logo: {
      'default': getExternalAssetFilePath('NEXT_PUBLIC_NETWORK_LOGO') || '/assets/seth-logo.png',
      dark: getExternalAssetFilePath('NEXT_PUBLIC_NETWORK_LOGO_DARK') || '/assets/seth-logo.png',
    },
    icon: {
