...
const TxsTable = ({
  ...
  return (
    <AddressHighlightProvider>
      <TableRoot minWidth={{ base: '1100px', lg: '980px' }}>
        <TableHeaderComponent top={ stickyHeader ? top : undefined }>
          <TableRow>
            { isSethCompact ? (
              <>
                <TableColumnHeader width="200px">Txn hash</TableColumnHeader>
                <TableColumnHeader width="120px">Method</TableColumnHeader>
                { showBlockInfo && (
                  <TableColumnHeader width="110px">Block</TableColumnHeader>
                ) }
                <TableColumnHeader width="120px">Age</TableColumnHeader>
                <TableColumnHeader width="180px">From</TableColumnHeader>
                <TableColumnHeader width="180px">To</TableColumnHeader>
                { !config.UI.views.tx.hiddenFields?.value && (
                  <TableColumnHeader width="120px" isNumeric>Value</TableColumnHeader>
                ) }
                { !config.UI.views.tx.hiddenFields?.tx_fee && (
                  <TableColumnHeader width="120px" isNumeric>Fee{ feeCurrency }</TableColumnHeader>
                ) }
              </>
            ) : (
              <>
        ...
        <TableBody>
          { socketType && !isSethCompact && <TxsSocketNotice type={ socketType } place="table" isLoading={ isLoading }/> }
