  ...
  return (
    <>
      ...
      <AccountPageDescription allowCut={ false }>
        <span>
          Verify ownership of a smart contract address to easily update information in Seth Explorer.
          ...
          Seth Explorer console without needing to sign additional messages.
        </span>
        ...
        <List.Root pl={ 5 } as="ol">
          ...
          <List.Item>
            ...
            <Link href="https://github.com/iPoW-Stack/SethExplorer" external noIcon>this tool</Link>
            <span>).</span>
          </List.Item>
        </List.Root>
        <chakra.div mt={ 5 }>
