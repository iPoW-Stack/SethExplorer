...
type LinkProps = EntityBase.LinkBaseProps & Partial<Pick<EntityProps, 'hash' | 'number' | 'poolIndex'>>;
...
const Link = chakra((props: LinkProps) => {
  ...
  if (props.poolIndex != null && !heightOrHash.startsWith('0x')) {
    query.pool_index = String(props.poolIndex);
  }
  const defaultHref = route(
    { pathname: '/block/[height_or_hash]', query },
