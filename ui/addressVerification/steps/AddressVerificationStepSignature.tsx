...
const AddressVerificationStepSignature = ({ address, signingMessage, contractCreator, contractOwner, onContinue, noWeb3Provider }: Props) => {
  ...
  const contactUsLink = <span>contact us <Link href="mailto:support@seth.app" rel="noopener noreferrer">support@seth.app</Link></span>;
  ...
  return (
    <FormProvider { ...formApi }>
      <form noValidate onSubmit={ onSubmit }>
        ...
        <Box mb={ 8 }>
          <span>Please select the address to sign and copy the message and sign it using the Seth Explorer message provider of your choice. </span>
          <Link href="https://github.com/iPoW-Stack/SethExplorer" external noIcon>
