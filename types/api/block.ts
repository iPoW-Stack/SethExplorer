...
/** Max pool index for sharded chains (e.g. Seth). pool_index in 0..BLOCK_POOL_INDEX_MAX (33 pools). */
export const BLOCK_POOL_INDEX_MAX = 32;
...
export interface Block {
  ...
  hash: string;
  parent_hash: string;
  /** Shard pool index (0–32). Present when chain has multiple blocks per height. */
